...
export const Vision = () => {
  ...
  return (
    <section 
      className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 lg:px-16 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden"
    >
      {/* Decorative elements */}
      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        >
          ...
          <div className="w-16 h-0 bg-primary/40 rounded-full mb-8"></div>

          <p className="text-lg sm:text-xl md:text-2xl text-gray-700 text-center max-w-4xl mx-auto leading-relaxed font-medium mb-8">
